...
//			WebDriverWait wait0 = new WebDriverWait(Ad, 30);
//			wait0.until(ExpectedConditions.presenceOfElementLocated(By.xpath(logindata[1][Cap])));
//			Ad.findElementByXPath(logindata[1][Cap]).click();
				...
				logStep("Here Login Required To Get The Contextual Locations");
				logStep("Login Done Successfully.");
